sap.ui.define([
		...
		opaTest("MasterList Filtering on Content less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<Content>").
		...
		opaTest("MasterList Filtering on Content more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <Unit>").
				and.iPressOKInViewSelectionDialog();
