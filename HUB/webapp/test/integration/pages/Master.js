			...
			onTheMasterPage : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ProductsSet", {
				...
				assertions : {
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("Content");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all ProductsSet to be able to check for the total amount
