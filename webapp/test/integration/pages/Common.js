sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("btech/szkolenia/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SzkolenieCezaryOlechwier-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SzkolenieCezaryOlechwier-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("btech.szkolenia.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["btech/szkolenia/localService/mockserver"], function (mockserver) {
