sap.ui.define([
	...
	return BaseObject.extend("btech.szkolenia.model.GroupSortState", {
		 ...
		 * @alias btech.szkolenia.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ProductId, or by Content
		 *
		...
		/**
		 * Groups by Content, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "Content") {
				...
				this._oViewModel.setProperty("/sortBy", "Content");

				aSorters.push(
					new Sorter("Content", false,
