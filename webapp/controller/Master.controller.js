...
sap.ui.define([
		...
		return BaseController.extend("btech.szkolenia.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("btech.szkolenia.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Content", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Content", FilterOperator.GT, 100));
							break;
						default :
							break;
					}
